...
const Shop = () => {
  ...
  const [products] = useState<Product[]>([
    {
      ...
      description: "Camisa deportiva de alta calidad, perfecta para entrenamientos intensos. Tela transpirable y diseño ergonómico."
    },
    {
      id: 2,
      ...
      description: "Camisa deportiva masculina con tecnología de secado rápido. Ideal para cualquier tipo de entrenamiento."
    },
    {
      id: 3,
      ...
      description: "Sudadera con capucha unisex, perfecta para antes y después del entrenamiento. Material suave y cómodo."
    },
    {
      id: 4,
      ...
      sizes: ["Único"],
      colors: ["Negro", "Rojo"],
      description: "Termo de acero inoxidable de 750ml. Mantiene la temperatura por 12 horas. Con logo de Arena Gym."
    }
  ]);
  ...
  return (
    <section id="tienda" ref={sectionRef} className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <h2 className="text-5xl font-bold text-gray-900 mb-4">
            Tienda <span className="text-red-600">Arena Gym</span>
          </h2>
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedProduct.sizes.map(size => (
                          <button
                            key={size}
                            className="px-3 py-2 border border-gray-300 rounded-lg hover:border-red-500 hover:bg-red-50 transition-colors duration-300"
                          >
                            {size}
                          </button>
                        ))}
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {selectedProduct.colors.map(color => (
                          <button
                            key={color}
                            className="px-3 py-2 border border-gray-300 rounded-lg hover:border-red-500 hover:bg-red-50 transition-colors duration-300 text-sm"
                          >
                            {color}
                          </button>
                        ))}
